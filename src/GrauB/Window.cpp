...
void Window::mouse_callback(GLFWwindow* window, double xposIn, double yposIn) {
    ...
    // Evita um salto brusco ("jump") na câmera quando o mouse entra na tela pela primeira vez
    if (win->firstMouse) {
        win->lastX = xpos;
        win->lastY = ypos;
    ...
    win->mouseOffsetY = win->lastY - ypos; // Invertido, porque o eixo Y cresce de cima para baixo
