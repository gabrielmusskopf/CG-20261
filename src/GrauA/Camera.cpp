...
{
    // Aplica a sensibilidade do mouse para o movimento rápido demais
    ...
    // Trava o eixo Y (Pitch) se solicitado
    ...
    // Usa a trigonometria já implementada para recalcular os vetores Front, Right e Up
    updateCameraVectors();
}
